    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <h1> Welcone to our system you can use Reat time chat using liverwire and can do all crud operation
                    using ajax call on books data
                </h1>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="http://localhost:8000/register"
                                    class="underline text-gray-900 dark:text-white">Register new account</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                if you are new user to our system you can make new account and authenticate  to use the  system.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="http://localhost:8000/login"
                                    class="underline text-gray-900 dark:text-white">Login to system</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                you can enter your email and your password to enter to system and if you forget password you can reset password through email.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="http://localhost:8000/books"
                                    class="underline text-gray-900 dark:text-white">Ajax CRUD operation</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                You can do all Crud operation write , delete , read , update and search on books on system.
                            </div>
                        </div>
                    </div>
